...
LIBS := \
	-L/Users/greg/git/mmap/lib \
	-v \
	-lc++

$(builddir)/mmap.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/mmap.node: LIBS := $(LIBS)
$(builddir)/mmap.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/mmap.node: TOOLSET := $(TOOLSET)
$(builddir)/mmap.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/mmap.node
# Add target alias
.PHONY: mmap
mmap: $(builddir)/mmap.node

# Short alias for building this executable.
.PHONY: mmap.node
mmap.node: $(builddir)/mmap.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/mmap.node
